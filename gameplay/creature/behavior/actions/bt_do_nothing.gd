...
## attack and a tunnel-mouth lurk, and retreating needs a nest-scoring pass with the distance
## term inverted. What DOES exist is every transition guard into and out of both states, so the
