...
func is_inside_landing_crater(position: Vector3) -> bool:
	return position.distance_to(AsteroidLayoutData.LANDING_CENTER) \
		< AsteroidLayoutData.LANDING_RADIUS


func is_inside_entrance_tunnel(position: Vector3) -> bool:
	return distance_to_line_segment(
		position,
		AsteroidLayoutData.ENTRANCE_START,
		AsteroidLayoutData.ENTRANCE_END
	) < AsteroidLayoutData.ENTRANCE_RADIUS


func is_inside_blue_chamber(position: Vector3) -> bool:
	return position.distance_to(AsteroidLayoutData.BLUE_ROOM_CENTER) \
...
func is_inside_purple_tunnel(position: Vector3) -> bool:
	return distance_to_line_segment(
		position,
		AsteroidLayoutData.PURPLE_TUNNEL_START,
		AsteroidLayoutData.PURPLE_TUNNEL_END
	) < AsteroidLayoutData.PURPLE_TUNNEL_RADIUS


func is_inside_purple_chamber(position: Vector3) -> bool:
	return position.distance_to(AsteroidLayoutData.PURPLE_ROOM_CENTER) \
...
func is_inside_core_tunnel(position: Vector3) -> bool:
	return distance_to_line_segment(
		position,
		AsteroidLayoutData.CORE_TUNNEL_START,
		AsteroidLayoutData.CORE_TUNNEL_END
	) < AsteroidLayoutData.CORE_TUNNEL_RADIUS


func is_inside_core_chamber(position: Vector3) -> bool:
	return position.distance_to(AsteroidLayoutData.CORE_ROOM_CENTER) \
...
func get_ore_type(position: Vector3) -> int:
	...
	if (
		is_near_segment(position, AsteroidLayoutData.PURPLE_VEIN_A_START,
			AsteroidLayoutData.PURPLE_VEIN_A_END, AsteroidLayoutData.PURPLE_VEIN_RADIUS)
		or is_near_segment(position, AsteroidLayoutData.PURPLE_DEPOSIT_1_CENTER,
			AsteroidLayoutData.PURPLE_VEIN_A_BRANCH_END, AsteroidLayoutData.PURPLE_VEIN_RADIUS)
		or is_near_segment(position, AsteroidLayoutData.PURPLE_VEIN_B_START,
			AsteroidLayoutData.PURPLE_VEIN_B_END, AsteroidLayoutData.PURPLE_VEIN_RADIUS)
		or is_near_segment(position, AsteroidLayoutData.PURPLE_VEIN_C_START,
			AsteroidLayoutData.PURPLE_VEIN_C_END, AsteroidLayoutData.PURPLE_VEIN_RADIUS)
	):
		return PURPLE_ORE

	if (
		is_near_segment(position, AsteroidLayoutData.BLUE_VEIN_A_START,
			AsteroidLayoutData.BLUE_VEIN_A_END, AsteroidLayoutData.BLUE_VEIN_RADIUS)
		or is_near_segment(position, AsteroidLayoutData.BLUE_DEPOSIT_1_CENTER,
			AsteroidLayoutData.BLUE_VEIN_A_BRANCH_END, AsteroidLayoutData.BLUE_VEIN_RADIUS)
		or is_near_segment(position, AsteroidLayoutData.BLUE_VEIN_B_START,
			AsteroidLayoutData.BLUE_VEIN_B_END, AsteroidLayoutData.BLUE_VEIN_RADIUS)
		or is_near_segment(position, AsteroidLayoutData.BLUE_DEPOSIT_2_CENTER,
			AsteroidLayoutData.BLUE_VEIN_B_BRANCH_END, AsteroidLayoutData.BLUE_VEIN_RADIUS)
		or is_near_segment(position, AsteroidLayoutData.BLUE_VEIN_C_START,
			AsteroidLayoutData.BLUE_VEIN_C_END, AsteroidLayoutData.BLUE_VEIN_RADIUS)
	):
		return BLUE_ORE
