...
EXAMPLE = "assets/art/examples/example_cubes_facing/sm_example_cubes_facing.gltf"
...
def test_a_bad_name_under_the_model_root_fails():
    report = vmf.ModelReport("assets/art/barrel/rain-barrel.gltf")
    vmf.check_filename(report, "assets/art/barrel/rain-barrel.gltf")
...
def test_a_bad_name_outside_the_model_root_is_only_noted():
    ...
    assert not report.failed, "naming must not be enforced outside assets/art/"
